...
<div class="row page-titles">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <h4 class="card-title">Data kategori <a href="<?php echo base_url();?>index.php/kelola_kategori/tambah_kategori"><button type="button" class="btn btn-info btn-flat btn-sm m-b-10 m-1-5">Tambah kategori</button></a></h4>
