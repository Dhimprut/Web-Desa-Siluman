  ...
  <div class="container article-container mt-5">
    <div class="row">
      ...
      <?php 
          ...
          $gallery_id = $this->uri->segment('3'); // Assuming the ID is the 4th segment in the URL

          // Loop through gallerys and display only the one that matches the ID
          foreach($gallery as $data) {
            if($data->id_gallery == $gallery_id) {
        ?>
          <div class="gallery-card mb-4">
            <img src="<?php echo base_url() ?>assets/gallery/<?php echo $data->gambar?>" class="card-img-top" alt="...">
