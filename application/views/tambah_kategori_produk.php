    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-outline-info">
                <div class="card-body">
                <form action="<?php echo base_url();?>index.php/kelola_kategori_produk/proses_tambah" method="post">
                    ...
                    <div class="row p-t-20">
                        <div class="col-md-12">
                            <div class="form-grouphas-success">
                                ...
                                <input type="text" id="firstName" required class="form-control input-default" name="nama_kategori_produk">
                            </div>
                        </div>
                    </div>
                </div>
